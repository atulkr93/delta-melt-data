...
fig, ax = plt.subplots(1, 7, figsize=(53.6, 8.4))

# degeneracy plots
plot_degeneracy(ax[0], '../figures5/bei_data/hpGBC_m6a/pH6.8_37C/', '', 'result_methtlCEST_37C', '', "hpGGACU" + "$^{m6A6}$" + " m" + "$^{6}$" + "A6-C2,C10\npH 6.8 37 " + "$^{\circ}$" + "C", [0., 350.], 0.643)
plot_degeneracy(ax[1], '../figures5/bei_data/hpGBC_m6a/pH6.8_55C/final/', 'hpGBCm6A_m6AC2_55C', '', '', "hpGGACU" + "$^{m6A6}$" + " m" + "$^{6}$" + "A6-C2\npH 6.8 55 " + "$^{\circ}$" + "C", [0., 1200.], 1.205)
plot_degeneracy(ax[2], '../figures5/bei_data/hpGBC_m6a/pH6.8_65C/final/', 'hpGBCm6A_m6A_C2_65C', '', '', "hpGGACU" + "$^{m6A6}$" + " m" + "$^{6}$" + "A6-C2\npH 6.8 65 " + "$^{\circ}$" + "C", [0., 2000.], 1.526)
plot_degeneracy(ax[3], '../figures5/bei_data/a6rna/final/', 'A6RNAm6A_C2_37', '', '', "A" + "$_{6}$" + "-RNA" + "$^{m6A16}$" + " m" + "$^{6}$"+ "A16-C2\npH 6.8 37 " + "$^{\circ}$" + "C", [0., 10.], 1.203)
ax[4].remove()
ax[5].remove()
ax[6].remove()
