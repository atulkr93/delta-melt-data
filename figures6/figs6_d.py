...
# degeneracy plots
plot_degeneracy(ax[0], '../figures5/600/scaf2_cgt/scaf2-CGT_G_5.4_LS_H2O_30C/global/new/', 'gc1p', '', '', "scaf2_CGT" + "$^{GC}$" + " G6-C8,C1'\npH 5.4 30 " + "$^{\circ}$" + "C", [0., 350.], 0.736)
plot_degeneracy(ax[1], '../figures5/600/scaf2_tgc/scaf2-TGC_G_5.4_LS_H2O_30C/global/final/', 'gc1p', '', '', "scaf2_TGC" + "$^{GC}$" + " G6-C8,C1'\npH 5.4 30 " + "$^{\circ}$" + "C", [0., 350.], 0.196)
plot_degeneracy(ax[2], '../figures5/600/scaf2_tgc/scaf2_tgc_600_hs/scaf2-TGC_G_5.4_HS_H2O_30C_remeasure/global/', 'G_C1p_Off', '', '', "scaf2_TGC" + "$^{GC}$" + "\npH 5.4HS 30 " + "$^{\circ}$" + "C", [0., 3.], 0.069)
plot_degeneracy(ax[3], '../figures5/600/scaf2_tgc/scaf2_tgc_600_hs/scaf2-TGC_G_5.4_HS_H2O_40C/global/new/', 'G_C1p_Off_clean', '', '', "scaf2_TGC" + "$^{GC}$" + "\npH 5.4HS 40 " + "$^{\circ}$" + "C", [0., 3.], 0.071)
plot_degeneracy(ax[4], '../figures5/600/scaf2_cgt/scaf2_cgt_rd_hs_30C/cest/', '', 'scaf2-CGT_GC1p_high_5.4', '', "scaf2_CGT" + "$^{GC}$" + " G6-C8,C1'\npH 5.4HS 30 " + "$^{\circ}$" + "C", [0., 50.], 0.203)
