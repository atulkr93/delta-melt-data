...
fig, axarr = plt.subplots(2, 6, figsize=(45, 13.5))
...
plot_uv(list(axarr[0, 3:]), '../figure9/cary_uv/scaf2_aaa_m1a_done/final_all/', 'test.csv', 'scaf2_AAA' + '$^{m1AT}$', [[0.5, 0.69], [0.62, 0.81], [0.52, 0.72]], 0.05, [[10, 100.0], [10., 100.], [10., 100.]], 20.0, 1, '2state', 'duplex')
...
#plt.show()
plt.tight_layout()
plt.savefig('figs2_athg_sequence.pdf')
