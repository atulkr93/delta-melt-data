...
plot_uv(list(axarr[0, :3]), '../figure9/cary_uv/scaf2_aaa_at_done/final_all/', 'test.csv', 'scaf2_AAA' + '$^{AT}$', [[0.59, 0.81], [0.59, 0.81], [0.59, 0.81]], 0.05, [[15, 100.], [15., 100.], [15., 100.]], 20.0, 1, '2state', 'duplex')
...
plot_uv(list(axarr[1, :3]), '../figure9/cary_uv/scaf2_aac_m3t_done/final_all/', 'test.csv', 'scaf2_AAC' + '$^{Am3T}$', [[0.52, 0.71], [0.52, 0.71], [0.61, 0.81]], 0.05, [[15, 100.], [15., 100.], [15., 100.]], 20.0, 1, '2state', 'duplex')
...
#plt.show()
plt.tight_layout()
plt.savefig('figs2_atopen_sequence_1.pdf')
