...
fig, axarr = plt.subplots(3, 6, figsize=(45, 22))
#fig, axarr = plt.subplots(2, 6)
fig.suptitle('pH 6.8', fontsize=fs)
plot_uv(axarr[0, :3], '../figure4/a2dna_ph6.8nb/final_all/', 'test.csv', 'A' + '$_{2}$' + '-DNA', [[0.49, 0.62], [0.59, 0.73], [0.62, 0.77]], 0.05, [[2, 95.0], [2., 95.], [2., 95.]], 20.0, 1, '2state', 'duplex')
plot_uv(axarr[0, 3:], '../figure4/a2dna_t16t9_ph6.8nb/final_all/', 'test.csv', 'A' + '$_{2}$' + '-DNA' + '$^{T16}$', [[0.58, 0.72], [0.59, 0.73], [0.58, 0.72]], 0.05, [[2, 95.0], [2., 95.], [2., 95.]], 20.0, 1, '2state', 'duplex')
plot_uv(axarr[1, :3], '../figure4/a6dna_ph6.8nb/final_all/', 'test.csv', 'A' + '$_{6}$' + '-DNA', [[0.58, 0.74], [0.55, 0.70], [0.61, 0.77]], 0.05, [[2, 95.0], [2., 95.], [2., 95.]], 20.0, 1, '2state', 'duplex')
plot_uv(axarr[1, 3:], '../figure4/a6dna_t16t9_ph6.8nb/final_all/', 'test.csv', 'A' + '$_{6}$' + '-DNA' + '$^{T16}$', [[0.51, 0.65], [0.52, 0.66], [0.51, 0.65]], 0.05, [[2, 95.0], [2., 95.], [2., 95.]], 20.0, 1, '2state', 'duplex')
plot_uv(axarr[2, :3], '../figure4/a6dna_t21t4_ph6.8nb/final_all/', 'test.csv', 'A' + '$_{6}$' + '-DNA' + '$^{T21}$', [[0.53, 0.67], [0.53, 0.67], [0.53, 0.67]], 0.05, [[2, 95.0], [2., 95.], [2., 95.]], 20.0, 1, '2state', 'duplex')
...
#plt.show()
plt.tight_layout()
plt.savefig('figs2_athg_tt_ph6p8.pdf')
