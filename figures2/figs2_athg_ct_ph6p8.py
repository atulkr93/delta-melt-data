...
plot_uv(axarr[0, 3:], '../figure4/a2dna_c16t9_ph6.8nb/final_all/', 'test.csv', 'A' + '$_{2}$' + '-DNA' + '$^{C16}$', [[0.58, 0.71], [0.59, 0.73], [0.58, 0.72]], 0.05, [[2, 95.0], [2., 95.], [2., 95.]], 20.0, 1, '2state', 'duplex')
...
plot_uv(axarr[1, 3:], '../figure4/a6dna_c16t9_ph6.8nb/final_all/', 'test.csv', 'A' + '$_{6}$' + '-DNA' + '$^{C16}$', [[0.57, 0.72], [0.55, 0.69], [0.55, 0.69]], 0.05, [[2, 95.0], [2., 95.], [2., 95.]], 20.0, 1, '2state', 'duplex')
plot_uv(axarr[2, :3], '../figure4/a6dna_c21t4_ph6.8nb/final_all/', 'test.csv', 'A' + '$_{6}$' + '-DNA' + '$^{C21}$', [[0.47, 0.58], [0.48, 0.59], [0.47, 0.59]], 0.05, [[2, 95.0], [2., 95.], [2., 95.]], 20.0, 1, '2state', 'duplex')
...
#plt.show()
plt.tight_layout()
plt.savefig('figs2_athg_ct_6p8.pdf')
