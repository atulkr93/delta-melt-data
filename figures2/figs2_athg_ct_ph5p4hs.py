...
plot_uv(axarr[0, 3:], '../figure4/a6dna_c16t9_ph5.4hsnb/final_all/', 'test.csv', 'A' + '$_{6}$' + '-DNA' + "$^{C16}$", [[0.61, 0.77], [0.61, 0.77], [0.61, 0.77]], 0.05, [[2, 95.0], [2., 95.], [2., 95.]], 20.0, 1, '2state', 'duplex')
...
plot_uv(axarr[1, 3:], '../figure4/a6dna_m1g10_c16t9_ph5.4hsnb/final_all/', 'test.csv', 'A' + '$_{6}$' + '-DNA' + "$^{m1G10,C16}$", [[0.56, 0.72], [0.56, 0.73], [0.56, 0.73]], 0.05, [[2, 95.0], [2., 95.], [2., 95.]], 20.0, 1, '2state', 'duplex')
...
#plt.show()
plt.tight_layout()
plt.savefig('figs2_athg_ct_5p4hs.pdf')
