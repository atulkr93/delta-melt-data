...
plot_uv(axarr[0, :3], '../figure4/a6dna_ph5.4nbhs/final_all/', 'test.csv', 'A' + '$_{6}$' + '-DNA', [[0.63, 0.79], [0.62, 0.78], [0.59, 0.75]], 0.05, [[2, 95.0], [2., 95.], [2., 95.]], 20.0, 1, '2state', 'duplex')
plot_uv(axarr[0, 3:], '../figure4/a6dna_t16t9_ph5.4hsnb/final_all/', 'test.csv', 'A' + '$_{6}$' + '-DNA' + "$^{T16}$", [[0.61, 0.78], [0.61, 0.78], [0.61, 0.78]], 0.05, [[2, 95.0], [2., 95.], [2., 95.]], 20.0, 1, '2state', 'duplex')
plot_uv(axarr[1, :3], '../figure4/a6dna_m1g10_ph5.4hsnb/final_all/', 'test.csv', 'A' + '$_{6}$' + '-DNA' + "$^{m1G10}$", [[0.59, 0.75], [0.59, 0.75], [0.59, 0.75]], 0.05, [[2, 95.0], [2., 95.], [2., 95.]], 20.0, 1, '2state', 'duplex')
plot_uv(axarr[1, 3:], '../figure4/a6dna_m1g10_t16t9_ph5.4hsnb/final_all/', 'test.csv', 'A' + '$_{6}$' + '-DNA' + "$^{m1G10,T16}$", [[0.57, 0.72], [0.57, 0.72], [0.57, 0.72]], 0.05, [[2, 95.0], [2., 95.], [2., 95.]], 20.0, 1, '2state', 'duplex')
...
#plt.show()
plt.tight_layout()
plt.savefig('figs2_athg_tt_5p4hs.pdf')
