...
fig, axarr = plt.subplots(3, 6, figsize=(45, 21))
#fig, axarr = plt.subplots(2, 6)
fig.suptitle('pH 4.4HS', fontsize=fs)
plot_uv(list(axarr[0, :6]) + list(axarr[1, :2]), '../figure4/a6dna_ph4.4hsnb/final_all/', 'test.csv', 'A' + '$_{6}$' + '-DNA', [[0.56, 0.73], [0.56, 0.72], [0.55, 0.72], [0.57, 0.73], [0.61, 0.78], [0.59, 0.74], [0.62, 0.78], [0.54, 0.69]], 0.05, [[2, 95.0], [2., 95.], [2., 95.], [2., 95.], [2., 95.], [2., 95.], [2., 95.], [2., 95.]], 20.0, 1, '2state', 'duplex')
plot_uv(axarr[1, 2:6], '../figure4/a6dna_c16t9_ph4.4hsnb/final_all/', 'test.csv', 'A' + '$_{6}$' + '-DNA' + '$^{C16}$', [[0.56, 0.72], [0.56, 0.72], [0.56, 0.72]], 0.05, [[2., 95.], [2., 95.], [2., 95.]], 20.0, 1, '2state', 'duplex')
plot_uv([axarr[1, 5]] + list(axarr[2, :3]), '../figure4/a6dna_c21t4_ph4.4hsnb/final_all/', 'test.csv', 'A' + '$_{6}$' + '-DNA' + '$^{C21}$', [[0.54, 0.70], [0.54, 0.70], [0.54, 0.70], [0.54, 0.70]], 0.05, [[2., 95.], [2., 95.], [2., 95.], [2., 95.0]], 20.0, 1, '2state', 'duplex')
...
#plt.show()
plt.tight_layout()
plt.savefig('figs2_athg_ct_4p4hs.pdf')
