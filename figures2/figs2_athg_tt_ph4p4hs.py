...
plot_uv(axarr[1, 2:6], '../figure4/a6dna_t16t9_ph4.4hsnb/final_all/', 'test.csv', 'A' + '$_{6}$' + '-DNA' + '$^{T16}$', [[0.58, 0.73], [0.59, 0.75], [0.57, 0.73]], 0.05, [[2., 95.], [2., 95.], [2., 95.]], 20.0, 1, '2state', 'duplex')
plot_uv([axarr[1, 5]] + list(axarr[2, :2]), '../figure4/a6dna_t21t4_ph4.4hsnb/final_all/', 'test.csv', 'A' + '$_{6}$' + '-DNA' + '$^{T21}$', [[0.55, 0.72], [0.54, 0.71], [0.54, 0.71]], 0.05, [[2., 95.], [2., 95.], [2., 95.]], 20.0, 1, '2state', 'duplex')
...
#plt.show()
plt.tight_layout()
plt.savefig('figs2_athg_tt_4p4hs.pdf')
