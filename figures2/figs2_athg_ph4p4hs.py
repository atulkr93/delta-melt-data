...
fig, axarr = plt.subplots(2, 6, figsize=(45, 14.))
#fig, axarr = plt.subplots(2, 6)
fig.suptitle('pH 4.4HS', fontsize=fs)
plot_uv(list(axarr[0, :6]) + list(axarr[1, :2]), '../figure3/cary_uv/a6dna_ph4.4hsnb/final_all/', 'test.csv', 'A' + '$_{6}$' + '-DNA', [[0.56, 0.73], [0.56, 0.72], [0.55, 0.72], [0.57, 0.73], [0.61, 0.78], [0.59, 0.74], [0.62, 0.78], [0.54, 0.69]], 0.05, [[2, 95.0], [2., 95.], [2., 95.], [2., 95.], [2., 95.], [2., 95.], [2., 95.], [2., 95.]], 20.0, 1, '2state', 'duplex')
plot_uv(axarr[1, 2:6], '../figure3/cary_uv/a6dna_m1a21_pH4.4hsnb/final_all/', 'test.csv', 'A' + '$_{6}$' + '-DNA' + '$^{m1A21}$', [[0.16, 0.46], [0.56, 0.74], [0.56, 0.74]], 0.05, [[10., 95.], [10., 95.], [10., 95.]], 20.0, 1, '2state', 'duplex')
...
#plt.show()
plt.tight_layout()
plt.savefig('figs2_athg_4p4hs.pdf')
