...
plot_uv(axarr[0, :3], '../figure6/cary_uv/a6dna_baseopen/final_all/', 'test.csv', 'A' + '$_{6}$' + '-DNA', [[0.60, 0.78], [0.60, 0.78], [0.60, 0.80]], 0.05, [[2, 95.0], [2., 95.], [2., 95.]], 20.0, 1, '2state', 'duplex')
plot_uv(axarr[0, 3:], '../figure6/cary_uv/a6dna_m3t6_open/final_all/', 'test.csv', 'A' + '$_{6}$' + '-DNA' + "$^{m3T6}$", [[0.60, 0.79], [0.60, 0.79], [0.60, 0.83]], 0.05, [[2, 95.0], [2., 95.], [2., 95.]], 20.0, 1, '2state', 'duplex')
