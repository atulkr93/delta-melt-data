...
plot_uv(axarr[0, 3:], '../figure4/a6dna_t16t9_ph5.4nb/final_all/', 'test.csv', 'A' + '$_{6}$' + '-DNA' + '$^{T16}$', [[0.59, 0.74], [0.59, 0.74], [0.59, 0.75]], 0.05, [[2., 95.], [2., 95.], [2., 95.]], 20.0, 1, '2state', 'duplex')
...
plot_uv(axarr[1, 3:], '../figure4/a6dna_rt16_ph5.4nb/final_all/', 'test.csv', 'A' + '$_{6}$' + '-DNA' + '$^{rT16}$', [[0.57, 0.72], [0.57, 0.72], [0.57, 0.72]], 0.05, [[2, 95.0], [2., 95.], [2., 95.]], 20.0, 1, '2state', 'duplex')
...
#plt.show()
plt.tight_layout()
plt.savefig('figs2_athg_tt_5p4.pdf')
