...
delg_array = compute_delG(p_array, t_array)
hpggacu_h = compute_deldelG('../figure7/dsgbc_m6a_ph6.8bb/test.csv', '../figure7/dsgbc_dm6a_ph6.8bb/test.csv', 'delH')
hpggacu_s = compute_deldelG('../figure7/dsgbc_m6a_ph6.8bb/test.csv', '../figure7/dsgbc_dm6a_ph6.8bb/test.csv', 'delS')
...
draw_bar(ax_two, hpggacu_h, hpggacu_b, '$\Delta\Delta H^{\circ}_{melt}$'+'(i)', '$\Delta H^{\circ}_{conf}$'+'(i)', [0., 17., 5], '%d', 'Enthalpy (kcal/mol)')
draw_bar(ax_three, hpggacu_s*1000, hpggacu_m*1000, '$\Delta\Delta S^{\circ}_{melt}$'+'(i)', '$\Delta S^{\circ}_{conf}$'+'(i)', [0., 40., 10], '%d', 'Entropy (cal/mol/K)')
plt.tight_layout()
plt.savefig('figs15c.pdf')
#plt.show()
