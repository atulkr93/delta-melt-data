...
#a6dna_h = compute_deldelG('a6dna_ph5.4/test.csv', 'a6dna_m1a16_ph5.4/test.csv', 'delH')
#a6dna_s = compute_deldelG('a6dna_ph5.4/test.csv', 'a6dna_m1a16_ph5.4/test.csv', 'delS')
...
#draw_bar(ax_two, a6dna_h, a6dna_b, '$\Delta\Delta H^{\circ}_{unfold}$', '$\Delta H^{\circ}_{conf,NMR}$', [0., 35., 10], '%d', 'Enthalpy (kcal/mol)')
#draw_bar(ax_three, a6dna_s*1000, a6dna_m*1000, '$\Delta\Delta S^{\circ}_{unfold}$', '$\Delta S^{\circ}_{conf,NMR}$', [0., 95., 20], '%d', 'Entropy (cal/mol/K)')
...
delg_array = compute_delG(p_array, t_array)
a6dna_ra16_h = compute_deldelG('../figure3/a6dna_ra16_ph5.4nb/test.csv', '../figure3/a6dna_m1ra16_ph5.4nb/test.csv', 'delH')
a6dna_ra16_s = compute_deldelG('../figure3/a6dna_ra16_ph5.4nb/test.csv', '../figure3/a6dna_m1ra16_ph5.4nb/test.csv', 'delS')
[a6dna_ra16_m, a6dna_ra16_b] = get_therm(ax_one, delg_array, t_array, [282., 289., 3.], [2.4, 4.0, 0.5], 'A-T Hoogsteen')
print "CHARTT", a6dna_ra16_h, a6dna_ra16_s*1000.
print "NMR", a6dna_ra16_b, a6dna_ra16_m*1000.
draw_bar(ax_two, a6dna_ra16_h, a6dna_ra16_b, '$\Delta\Delta H^{\circ}_{melt}$'+'(i)', '$\Delta H^{\circ}_{conf}$'+'(i)', [0., 40., 10], '%d', 'Enthalpy (kcal/mol)')
draw_bar(ax_three, a6dna_ra16_s*1000, a6dna_ra16_m*1000, '$\Delta\Delta S^{\circ}_{melt}$'+'(i)', '$\Delta S^{\circ}_{conf}$'+'(i)', [0., 110., 30], '%d', 'Entropy (cal/mol/K)')
