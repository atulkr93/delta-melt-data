...
draw_corr(ax_one, chartt_dels, rd_dels, '$\Delta\Delta S^{\circ}_{melt}$' + '(i) (cal/mol/K)', '$\Delta S^{\circ}_{conf}$' + '(i) (cal/mol/K)', dels_lim, np.arange(-40, 81, 40), '%d', rd_resi)

plt.savefig('figs15d_2.pdf')
#plt.show()
