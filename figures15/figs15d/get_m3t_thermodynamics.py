# Get the delH and delS for introduction of
# A-m3T base pairs in TBP-DNA
import sys
import pandas as pd
from uncertainties import ufloat
from uncertainties import unumpy

bf1 = pd.read_csv('../../figure6/opening/CDNA/wt/test.csv')
delh1 = ufloat(bf1['delH'].iloc[-2], bf1['delH'].iloc[-1])
dels1 = ufloat(bf1['delS'].iloc[-2], bf1['delS'].iloc[-1])
f = open('m3t_delh_dels.csv', 'w')
...
for dummy in ['m3T3', 'm3T5', 'm3T16', 'm3T17', 'm3T18', 'm3T19', 'm3T21']:
    filename2 = '../../figure6/opening/CDNA/' + dummy + '/' + 'test.csv'
