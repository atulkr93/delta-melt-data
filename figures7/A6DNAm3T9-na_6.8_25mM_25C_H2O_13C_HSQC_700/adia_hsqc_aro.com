...
| nmrPipe  -fn FT -auto                               \
| nmrPipe  -fn PS -p0 -52.40 -p1 -16.00 -di -verb         \
| nmrPipe  -fn EXT -xn 8.5ppm -x1 6ppm -sw -verb    \
| nmrPipe  -fn TP                                     \
| nmrPipe  -fn SP -off 0.5 -end 1.00 -pow 1 -c 0.5    \
| nmrPipe  -fn ZF -size 8192                               \
| nmrPipe  -fn FT -auto                               \
| nmrPipe  -fn PS -p0 96.00 -p1 0.00 -di -verb         \
   -ov -out test.ft2
#pipe2ucsf test.ft2 A6_m3T9_adia_HSQC_Aro.ucsf
