...
| nmrPipe  -fn FT -auto                               \
| nmrPipe  -fn PS -p0 -85.30 -p1 -124.00 -di -verb         \
| nmrPipe  -fn EXT -xn 3.0ppm -x1 2.4ppm -sw -verb    \
| nmrPipe  -fn TP                                     \
| nmrPipe  -fn SP -off 0.5 -end 1.00 -pow 1 -c 0.5    \
| nmrPipe  -fn ZF -size 8192                               \
| nmrPipe  -fn FT -auto                               \
| nmrPipe  -fn PS -p0 141.00 -p1 0.00 -di -verb         \
| nmrPipe  -fn EXT -xn 148ppm -x1 138ppm -sw -verb    \
   -ov -out test.ft2
#pipe2ucsf test.ft2 A6_m3T9_adia_HSQC_Me.ucsf
