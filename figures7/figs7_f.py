...
plot_spectrum(ax_imino1, 'A6DNA-na_6.8_25mM_25C_H2O_Imino_HSQC_600/', 1.5*math.pow(10, 6), 20, 1.4, "H3 (ppm)", "N3 (ppm)", [14.1, 13.5], [14.1, 13.5, 0.3], [161, 158], [161., 158.0, 2.0], 'A6DNA_sofast_HMQC_Imino_T.list', "N3", '%2.1f', '%d', "", 'k', 'test.ft2', 1)
plot_spectrum(ax_imino1, 'A6DNAm3T9-na_6.8_25mM_25C_H2O_Imino_HSQC_600/', 1.*math.pow(10, 6), 20, 1.4, "H3 (ppm)", "N3 (ppm)", [14.1, 13.5], [14.1, 13.5, 0.3], [161, 158], [161., 158.0, 2.0], 'A6DNAm3T9_sofast_HMQC_Imino_T.list', "N3", '%2.1f', '%d', "", 'r', 'test.ft2', 1)


plt.savefig('figs7_f_1.pdf')
#plt.show()
