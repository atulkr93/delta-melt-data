...
plot_spectrum(ax_c1p, 'A6DNA-na_6.8_25mM_25C_H2O_13C_HSQC_600/', 6.*math.pow(10, 6), 20, 1.4, "H1' (ppm)", "C1' (ppm)", [6.4, 5.1], [6.4, 5.2, 0.4], [145, 139], [89., 83., 3.0], 'A6DNA_adia_HSQC_Ali.list', "C1'", '%2.1f', '%d', "", 'k', 'test.ft2', 1)
plot_spectrum(ax_c1p, 'A6DNAm3T9-na_6.8_25mM_25C_H2O_13C_HSQC_700/', 3.*math.pow(10, 6), 20, 1.4, "H1' (ppm)", "C1' (ppm)", [6.4, 5.1], [6.4, 5.2, 0.4], [145, 139], [89., 83., 3.0], 'A6_m3T9_adia_HSQC_Ali.list', "C1'", '%2.1f', '%d', "", 'r', 'test2.ft2', 1)


plt.savefig('figs7_e.pdf')
#plt.show()
