...
plot_spectrum(ax_aro, 'A6DNA-na_6.8_25mM_25C_H2O_13C_HSQC_600/', 1.*math.pow(10, 7), 20, 1.4, "H6/8 (ppm)", "C6/8 (ppm)", [8.4, 6.8], [8.4, 7.0, 0.5], [145, 137], [144., 138.0, 2.0], 'A6DNA_adia_HSQC_Aro.list', "C6", '%2.1f', '%d', "", 'k', 'test.ft2', 1)
