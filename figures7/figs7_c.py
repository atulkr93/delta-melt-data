...
plot_spectrum(ax_noe1, 'A6DNAm3T9-na_6.8_25mM_25C_H2O_NOESY_HSQC_600/', 5.*math.pow(10, 6), 20, 1.4, "H1 (ppm)", "Methyl H (ppm)", [13.1, 12.8], [13.0, 12.9, 0.1], [2.9, 2.6], [2.9, 2.6, 0.2], 'A6DNAm3T9_150ms_NOESY_T9_gn1.list', "", '%2.1f', '%2.1f', "", 'r', 'test.ft2', 1)
plot_spectrum(ax_noe2, 'A6DNAm3T9-na_6.8_25mM_25C_H2O_NOESY_HSQC_600/', 5.*math.pow(10, 6), 20, 1.4, "H4b (ppm)", "Methyl H (ppm)", [8.8, 8.4], [8.8, 8.4, 0.2], [2.9, 2.6], [2.9, 2.6, 0.2], 'A6DNAm3T9_150ms_NOESY_c15h4b.list', "", '%2.1f', '%2.1f', "", 'r', 'test.ft2', 0)
plot_spectrum(ax_noe3, 'A6DNAm3T9-na_6.8_25mM_25C_H2O_NOESY_HSQC_600/', 5.*math.pow(10, 6), 20, 1.4, "H2/H6 (ppm)", "Methyl H (ppm)", [7.5, 7.3], [7.45, 7.35, 0.1], [2.9, 2.6], [2.9, 2.6, 0.2], 'A6DNAm3T9_150ms_NOESY_h2h6.list', "", '%3.2f', '%2.1f', "", 'r', 'test.ft2', 0)

plt.savefig('figs7_c.pdf')
#plt.show()
