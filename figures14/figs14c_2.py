...
bf = pd.read_csv('../figure9/cary_uv/m3t_25c_new.csv')
contexts_exclude = ['aaa', 'aag', 'gac', 'tag', 'cac', 'gag']
...
plot_contexts(bf, ax, 'a', contexts_exclude, np.arange(6.0, 9.1, 1.0), '%d', 'A-T Opening\n' + '$\Delta\Delta G_{delta-melt, 25^{\\circ}C}^{\\circ}$'+ ' (kcal/mol)')

plt.savefig('figs14c_2.pdf')
#plt.show()
