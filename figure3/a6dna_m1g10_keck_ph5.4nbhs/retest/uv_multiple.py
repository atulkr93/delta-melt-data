...
def fit_data(temperature, absorbance, mode, Ct):
    ...
    if mode == 'hairpin': 
        ...
        plt.figure(1)
        plt.plot(temperature, absorbance, color='k', linewidth=3)
        plt.plot(np.linspace(5,100,500), uv_hairpin(np.linspace(5,100,500), *popt), color='b')
        plt.show()
        ...
        print "Duplex"
        p0 = np.array([0.0001, 0.3, 0.0001, 0.4, -80, 310])
        ...
        plt.figure(1)
        plt.plot(temperature, absorbance, color='k', linewidth=3)
        plt.plot(np.linspace(5,100,500), uv_duplex(np.linspace(5,100,500), *popt), color='b')
        plt.show()
