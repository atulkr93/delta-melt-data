# Plot delta-melt correlation for CT mismatches
...
a6dna_a16_ph4p4hs_ddg = compute_deldelG('a6dna_ph4.4hsnb/final_all/test.csv', 'a6dna_c16t9_ph4.4hsnb/final_all/test.csv', 'delG_25C', 1)
a6dna_a16_ph4p4hs_rd = compute_delG(0.888, 0.043, 25, 1)

a6dna_a16_ph5p4lsnb_17p5c_ddg = compute_deldelG('a6dna_ph5.4nb/final_all/test.csv', 'a6dna_c16t9_ph5.4nb/final_all/test.csv', 'delG_17.5C', 1)
a6dna_a16_ph5p4lsnb_17p5c_rd = compute_delG(0.463, 0.019, 17.5, 1)

a6dna_a16_ph5p4lsnb_20c_ddg = compute_deldelG('a6dna_ph5.4nb/final_all/test.csv', 'a6dna_c16t9_ph5.4nb/final_all/test.csv', 'delG_20.0C', 1)
a6dna_a16_ph5p4lsnb_20c_rd = compute_delG(0.459, 0.030, 20.0, 1)

a6dna_a16_ph5p4lsnb_22p5c_ddg = compute_deldelG('a6dna_ph5.4nb/final_all/test.csv', 'a6dna_c16t9_ph5.4nb/final_all/test.csv', 'delG_22.5C', 1)
a6dna_a16_ph5p4lsnb_22p5c_rd = compute_delG(0.559, 0.047, 22.5, 1)

a6dna_a16_ph5p4lsnb_25c_ddg = compute_deldelG('a6dna_ph5.4nb/final_all/test.csv', 'a6dna_c16t9_ph5.4nb/final_all/test.csv', 'delG_25C', 1)
a6dna_a16_ph5p4lsnb_25c_rd = compute_delG(0.629, 0.081, 25.0, 1)

a6dna_ra16_ph5p4_10c_ddg = compute_deldelG('a6dna_ra16_ph5.4nb/final_all/test.csv', 'a6dna_rc16_ph5.4nb/final_all/test.csv', 'delG_10C', 1)
a6dna_ra16_ph5p4_10c_rd = compute_delG(0.180, 0.008, 10, 1)

a6dna_ra16_ph5p4_12p5c_ddg = compute_deldelG('a6dna_ra16_ph5.4nb/final_all/test.csv', 'a6dna_rc16_ph5.4nb/final_all/test.csv', 'delG_12.5C', 1)
a6dna_ra16_ph5p4_12p5c_rd = compute_delG(0.286, 0.046, 12.5, 1)

a6dna_ra16_ph5p4_15c_ddg = compute_deldelG('a6dna_ra16_ph5.4nb/final_all/test.csv', 'a6dna_rc16_ph5.4nb/final_all/test.csv', 'delG_15C', 1)
...
a6dna_a16_ph5p4hsnb_25c_ddg = compute_deldelG('a6dna_ph5.4nbhs/final_all/test.csv', 'a6dna_c16t9_ph5.4hsnb/final_all/test.csv', 'delG_25C', 1)
a6dna_a16_ph5p4hsnb_25c_rd = compute_delG(0.498, 0.038, 25., 1)

a6dnam1g_a16_ph5p4hsnb_ddg = compute_deldelG('a6dna_m1g10_ph5.4hsnb/final_all/test.csv', 'a6dna_m1g10_c16t9_ph5.4hsnb/final_all/test.csv', 'delG_25C', 1)
a6dnam1g_a16_ph5p4hsnb_rd = compute_delG(2.460, 0.041, 25, 1)

# weak rd
a2dna_a16_ph6p9hb_25c_ddg = compute_deldelG('a2dna_ph6.8nb/final_all/test.csv', 'a2dna_c16t9_ph6.8nb/final_all/test.csv', 'delG_25C',0)
a2dna_a16_ph6p9hb_25c_rd = compute_delG(0.252, 0.086, 25., 0)

a6dna_a16_ph6p8_ddg = compute_deldelG('a6dna_ph6.8nb/final_all/test.csv', 'a6dna_c16t9_ph6.8nb/final_all/test.csv', 'delG_25C', 1)
a6dna_a16_ph6p8_rd = compute_delG(0.441, 0.058, 25, 1)

a6dna_a21_ph6p8_25c_ddg = compute_deldelG('a6dna_ph6.8nb/final_all/test.csv', 'a6dna_c21t4_ph6.8nb/final_all/test.csv', 'delG_25C', 1)
a6dna_a21_ph6p8_25c_rd = compute_delG(0.204, 0.029, 25, 1)

a6dna_a21_ph6p8_30c_ddg = compute_deldelG('a6dna_ph6.8nb/final_all/test.csv', 'a6dna_c21t4_ph6.8nb/final_all/test.csv', 'delG_30C', 1)
a6dna_a21_ph6p8_30c_rd = compute_delG(0.205, 0.019, 30, 1)

a6dna_a21_ph4p4hsnb_30c_ddg = compute_deldelG('a6dna_ph4.4hsnb/final_all/test.csv', 'a6dna_c21t4_ph4.4hsnb/final_all/test.csv', 'delG_30C', 1)
a6dna_a21_ph4p4hsnb_30c_rd = compute_delG(0.369, 0.026, 30, 1)
#print a6dna_a21_ph4p4hsnb_30c_ddg, a6dna_a21_ph4p4hsnb_30c_rd
...
# shaded lines
x_dummy = np.linspace(0.0, 5.0, 100)
...
plot_point(a6dna_a21_ph4p4hsnb_30c_ddg, a6dna_a21_ph4p4hsnb_30c_rd, 'blue')
...
plt.plot([1.65, 5.0], [(1.65*line_coeff[0]) + line_coeff[1], (5*line_coeff[0]) + line_coeff[1]], color='k', linewidth=2, zorder=10)
plt.fill_between(x_dummy, np.amin(line_matrix, axis=0), np.amax(line_matrix, 0), color='#B0E2FF', zorder=0)

plt.title('CT mismatches')
...
#plt.text(3.7, 2.0, eqn2, fontsize=18)
