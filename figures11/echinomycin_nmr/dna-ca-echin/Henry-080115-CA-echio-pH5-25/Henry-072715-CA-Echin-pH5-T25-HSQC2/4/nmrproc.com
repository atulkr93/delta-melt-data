...
nmrPipe -in ./test.fid \
| nmrPipe  -fn SP -off 0.50 -end 1.00 -pow 4 -c 0.5 	 	\
| nmrPipe  -fn ZF -size 8192                             	\
| nmrPipe  -fn FT -auto                               	 	\
| nmrPipe  -fn PS -p0 97.4 -p1 0 -di -verb         		\
| nmrPipe  -fn TP                                     		\
| nmrPipe  -fn SP -off 0.50 -end 1.00 -pow 4 -c 0.5    		\
| nmrPipe  -fn ZF -size 2048                              	\
| nmrPipe  -fn FT -auto                       			\
| nmrPipe  -fn PS -p0 -93.6 -p1 180 -di -verb         		\
   -ov -out out.ft2
#pipe2ucsf out.ft2 Henry-072715-CA-Echin-pH5-T25-HSQC2-Caro.ucsf
