...
def plot_1d_spectrum(ax, dirname, filename, xlim, xticks, xfmt_string, title, ylim, xlabel, plot_color):
...
fig, ax = plt.subplots()
plot_1d_spectrum(ax, 'dna-acgtacgtat-echin/Henry-062116-ACACGTAT-Echin-pH6.8-25C/SFIMINO/', 'out.ft2', [14.2, 11.0], [14.0, 11.0, 1.0], "%d", "25 " + "$^{\circ}$" + "C", [-10000000., 1.7*math.pow(10,8)], "H1/H3 (ppm)", '#8c3a95')
plot_1d_spectrum(ax, 'dna-acgtacgtat-echin/Henry-062316-ACACGTAT-Echin-pH6.8-10C/SFIMINO/', 'out.ft2', [14.2, 11.0], [14.0, 11.0, 1.0], "%d", "10 " + "$^{\circ}$" + "C", [-10000000., 1.7*math.pow(10,8)], "H1/H3 (ppm)", '#42b549')
#plt.show()
plt.savefig('figs11_i.pdf')
