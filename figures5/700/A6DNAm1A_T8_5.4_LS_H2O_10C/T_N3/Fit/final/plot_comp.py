...
def draw_subplot(dirname, ax):
    rd_data_net = pd.read_csv(dirname + "2state/Local/Data_T8_N3_Off_1.csv")
    params = pd.read_csv(dirname + "2state/LocalFits_T8_N3_Off.csv")
...
dirname_list = [0.1, 0.25, 0.50, 0.75, 1.0, 1.25, 1.5, 1.75, 2.0, 2.2, 2.3, 2.3, 2.4, 2.5, 2.6, 2.7, 2.8, 3.0, 5.0, 8.0, 10.0]
#dirname_list = [0.1, 0.25, 0.50, 0.75, 1.0, 1.25, 1.5, 1.75, 2.0, 2.2, 2.4, 2.5, 2.6, 2.7, 2.8, 3.0, 5.0, 10.0]
horiz_counter = 0
vert_counter = 0
