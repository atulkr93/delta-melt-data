import os
#pb_dir = [0.05, 0.1, 0.15, 0.20, 0.25, 0.30, 0.40, 0.45, 0.50, 0.75, 1.0, 2.0, 2.5, 3.0, 5.0, 8.0, 10.0]
#pb_dir = [2.0, 8.0, 10.0]
#pb_dir = [2.3, 2.4, 2.6, 2.7]
pb_dir = [2.8, 2.9]
