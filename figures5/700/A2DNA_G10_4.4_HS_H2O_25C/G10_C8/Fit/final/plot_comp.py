...
def draw_subplot(dirname, ax):
    rd_data_net = pd.read_csv(dirname + "2state/Local/Data_G10_C8_Off_1.csv")
    params = pd.read_csv(dirname + "2state/LocalFits_G10_C8_Off.csv")
...
dirname_list = [0.1, 0.15, 0.20, 0.25, 0.30, 0.40, 0.45, 0.50, 0.75, 1.0, 2.0, 2.5, 3.0, 5.0, 8.0, 10.0]
