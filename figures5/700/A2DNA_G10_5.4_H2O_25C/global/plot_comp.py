...
def draw_subplot(dirname, ax):
    #rd_data_net = pd.read_csv(dirname + "2state/Local/Data_g10c1p_1.csv")
    #params = pd.read_csv(dirname + "2state/LocalFits_g10c1p.csv")
    rd_data_net = pd.read_csv(dirname + "2state/Local/Data_g10c8_1.csv")
    params = pd.read_csv(dirname + "2state/LocalFits_g10c8.csv")
...
dirname_list = [0.1, 0.20, 0.30, 0.50, 0.70, 0.90, 1.0, 1.3, 1.6, 2.0, 2.5, 3.0, 3.5, 5.0, 8.0, 10.0]
horiz_counter = 0
vert_counter = 0
