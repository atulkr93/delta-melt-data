import os
#pb_dir = [0.1, 0.20, 0.30, 0.50, 0.70, 0.90, 1.0, 1.3, 1.6, 2.0, 2.5, 3.0, 3.5, 5.0, 8.0, 10.0]
#pb_dir = [13, 1.6, 2.0, 2.5, 3.0, 3.5, 5.0, 8.0, 10.0]
pb_dir = [1.1]
...
for dummy in range(len(pb_dir)):
    ...
    os.system('ln -s ../g10c1p.csv .')
    os.system('ln -s ../g10c8.csv .')
