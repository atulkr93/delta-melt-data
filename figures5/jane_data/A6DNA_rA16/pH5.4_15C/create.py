import os
pb_dir = [0.01, 0.05, 0.1, 0.20, 0.25, 0.30, 0.35, 0.40, 0.50, 0.75, 1.0, 2.0, 3.0, 5.0, 8.0, 10.0]
...
for dummy in range(len(pb_dir)):
    ...
    os.system('ln -s ../ra16_c8_15c.csv .')
