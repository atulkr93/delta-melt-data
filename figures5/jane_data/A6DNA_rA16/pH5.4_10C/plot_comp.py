...
def draw_subplot(dirname, ax):
    rd_data_net = pd.read_csv(dirname + "2state/Local/Data_ra16_c8_10c_1.csv")
    params = pd.read_csv(dirname + "2state/LocalFits_ra16_c8_10c.csv")
...
dirname_list = [0.01, 0.05, 0.1, 0.15, 0.20, 0.25, 0.30, 0.40, 0.50, 0.75, 1.0, 2.0, 3.0, 5.0, 8.0, 10.0]
