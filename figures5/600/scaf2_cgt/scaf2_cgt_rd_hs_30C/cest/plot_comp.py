...
def draw_subplot(dirname, ax):
    global lf
    rd_data_net = pd.read_csv(dirname + "2state/fit-scaf2-CGT_GC1p_high_5.4.csv")
    params = pd.read_csv(dirname + "2state/fitparams-scaf2-CGT_GC1p_high_5.4.csv")
    #rd_data_net = pd.read_csv(dirname + "2state/fit-scaf2-CGT_GC8_high_5.4.csv")
    #params = pd.read_csv(dirname + "2state/fitparams-scaf2-CGT_GC8_high_5.4.csv")
