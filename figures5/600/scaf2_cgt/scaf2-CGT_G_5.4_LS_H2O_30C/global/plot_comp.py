...
def draw_subplot(dirname, ax):
    ...
    color_slp = {200.0: 'green', 300.0:'yellow', 400.0:'orange', 900.0:'red', 1000.0:'cyan', 1200.0:'magenta'}
...
dirname_list = [0.1, 0.20, 0.30, 0.50, 0.6, 0.65, 0.70, 0.75, 0.8, 0.90, 1.0, 1.3, 1.6, 2.0, 2.5, 3.0, 3.5, 5.0, 8.0, 10.0] 
horiz_counter = 0
vert_counter = 0
