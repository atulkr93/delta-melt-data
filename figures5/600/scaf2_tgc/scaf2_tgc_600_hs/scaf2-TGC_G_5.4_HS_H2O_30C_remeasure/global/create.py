...
#pb_dir = [0.01, 0.05, 0.1, 0.20, 0.30, 0.40, 0.50, 0.6, 0.75, 1.0, 2.0, 3.0, 5.0, 8.0, 10.0]
#pb_dir = [0.02, 0.03, 0.04, 0.06, 0.07, 0.08, 0.09]
#pb_dir = [0.15]
pb_dir = [0.9, 1.3, 1.6, 2.2, 2.3, 2.4, 2.5, 2.6, 2.7, 3.5]
...
for dummy in range(len(pb_dir)):
    ...
    os.system('ln -s ../G_C8_Off.csv .')
    os.system('ln -s ../G_C1p_Off.csv .')
