...
pb_dir = [0.01, 0.05, 0.1, 0.20, 0.30, 0.40, 0.50, 0.75, 1.0, 2.0, 3.0, 5.0, 8.0, 10.0, 20.0]
...
+
Name G_C1p_Off_reduce_new_trunc.csv
lf 150.88
Temp 25.0
AlignMag AUTO
#Trelax 0.0005 0.5
...
for dummy in range(len(pb_dir)):
    ...
    os.system('ln -s ../G_C1p_Off_reduce_new_trunc.csv .')
