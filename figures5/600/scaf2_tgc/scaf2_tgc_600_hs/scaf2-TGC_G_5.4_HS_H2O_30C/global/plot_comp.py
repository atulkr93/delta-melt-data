...
def draw_subplot(dirname, ax):
    ...
    rd_data_net = pd.read_csv(dirname + "2state/Local/Data_G_C1p_Off_reduce_new_trunc_1.csv")
    params = pd.read_csv(dirname + "2state/LocalFits_G_C1p_Off_reduce_new_trunc.csv")
...
dirname_list = [0.01, 0.05, 0.1, 0.20, 0.30, 0.40, 0.50, 0.75, 1.0, 2.0, 3.0, 5.0, 8.0]
