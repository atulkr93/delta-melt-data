import os
pb_dir = [0.01, 0.05, 0.1, 0.20, 0.30, 0.40, 0.50, 0.6, 0.75, 1.0, 2.0, 3.0, 5.0, 8.0]
...
+
Name result_methtlCEST_37C.csv
lf 150.88
AlignMag AUTO
resn 1.0
eqbn Y
...
+
Name result_hpGBCm6A_C2_37C.csv
lf 150.88
AlignMag AUTO
resn 1.0
eqbn N
...
for dummy in range(len(pb_dir)):
    ...
    os.system('cp ../result_methtlCEST_37C.csv .')
    os.system('cp ../result_hpGBCm6A_C2_37C.csv .')
