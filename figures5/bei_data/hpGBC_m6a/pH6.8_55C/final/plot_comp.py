...
def draw_subplot(dirname, ax):
    rd_data_net = pd.read_csv(dirname + "2state/Local/Data_hpGBCm6A_m6AC2_55C_1.csv")
    params = pd.read_csv(dirname + "2state/LocalFits_hpGBCm6A_m6AC2_55C.csv")
...
dirname_list =  [0.01, 0.1, 0.25, 0.50, 0.75, 0.9, 1.0, 1.1, 1.2, 1.3, 1.4, 1.5, 2.0, 3.0, 5.0, 8.0, 10.0]
