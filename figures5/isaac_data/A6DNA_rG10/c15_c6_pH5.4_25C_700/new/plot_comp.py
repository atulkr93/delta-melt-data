...
def draw_subplot(dirname, ax):
    rd_data_net = pd.read_csv(dirname + "2state/Local/Data_c15_c6_1.csv")
    params = pd.read_csv(dirname + "2state/LocalFits_c15_c6.csv")
    color_slp = {200.0: 'green', 300.0:'yellow', 400.0:'orange', 900.0:'red', 1000.0:'cyan', 1200:'magenta', 1400:'black', 1600:'violet'}
...
dirname_list = [0.05, 0.1, 0.20, 0.30, 0.35, 0.40, 0.45, 0.50, 0.55, 0.60, 0.65, 0.70, 0.8, 0.9, 1.0, 2.0, 3.0, 5.0, 8.0]
