...
for dummy in range(len(pb_dir)):
    ...
    os.system('ln -s ../G7C1p_pH5.3HS_25C.csv .')
    os.system('ln -s ../G7C8_pH5.3HS_25C.csv .')
    os.system('ln -s ../G7N1_pH5.3HS_25C.csv .')

    f = open('BMNS_params.txt', 'w')
    f.write(opfile%(pb_decimals[dummy], pb_decimals[dummy], pb_decimals[dummy]))
    f.close()
