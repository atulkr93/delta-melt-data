...
def draw_subplot(dirname, ax):
    #rd_data_net = pd.read_csv(dirname + "2state/Local/Data_G7C8_pH5.3HS_25C_1.csv")
    #params = pd.read_csv(dirname + "2state/LocalFits_G7C8_pH5.3HS_25C.csv")
    #rd_data_net = pd.read_csv(dirname + "2state/Local/Data_G7C1p_pH5.3HS_25C_1.csv")
    #params = pd.read_csv(dirname + "2state/LocalFits_G7C1p_pH5.3HS_25C.csv")
    rd_data_net = pd.read_csv(dirname + "2state/Local/Data_G7N1_pH5.3HS_25C_1.csv")
    params = pd.read_csv(dirname + "2state/LocalFits_G7N1_pH5.3HS_25C.csv")
    color_slp = {200.0: 'green', 300.0:'yellow', 400.0:'orange', 900.0:'red', 1000.0:'cyan', 1200:'magenta'}
...
dirname_list = [0.01, 0.05, 0.1, 0.15, 0.20, 0.25, 0.30, 0.40, 0.45, 0.50, 0.75, 1.0, 2.0, 3.0, 5.0, 8.0] 
#dirname_list = [0.05, 0.1, 0.15, 0.20, 0.25, 0.30, 0.40, 0.45, 0.50, 0.75, 2.0, 3.0, 5.0, 8.0] 
