...
fig, ax = plt.subplots(1, 6, figsize=(48.1, 9.1))
...
plot_spectrum(ax[0], 'A6DNAs2lb_5.4_25mM_10C_H2O_NH_HSQC_700/', 5.*math.pow(10, 6), 20, 1.4, "H3 (ppm)", "N3 (ppm)", [14.25, 13.65], [14.2, 13.8, 0.2], [160.6, 158.], [160., 158., 1.], 'A6DNA_T6lb_NHHSQC_Imino_5.4_10C_N3.list', "N3", '%2.1f', '%d', "A" + "$_{6}$" + "-DNA(s2lb)\npH 5.4 10 " + "$^{\circ}$" + "C")
plot_spectrum(ax[1], 'A6DNAs2lb_5.4_25mM_10C_H2O_NH_HSQC_700/', 5.*math.pow(10, 6), 20, 1.4, "H1 (ppm)", "N1 (ppm)", [13.2, 12.75], [13.2, 12.8, 0.3], [148., 146.], [148., 146., 1.], 'A6DNA_T6lb_NHHSQC_Imino_5.4_10C_N1.list', "N1", '%2.1f', '%d', "A" + "$_{6}$" + "-DNA(s2lb)\npH 5.4 10 " + "$^{\circ}$" + "C")
plot_spectrum(ax[2], 'A6DNAA16lb_5.4_150mM_25C_H2O_C1H1_HSQC_600/', 1.*math.pow(10, 6), 20, 1.4, "H1' (ppm)", "C1' (ppm)", [5.9, 5.5], [5.9, 5.6, 0.2], [85., 84.], [85., 84., 1.], 'A6DNAA16lb_high_5.4_HSQC_25C_Ali.list', "C1'", '%2.1f', '%d', "A" + "$_{6}$" + "-DNA(A16lb)\npH 5.4HS 25 " + "$^{\circ}$" + "C")
plot_spectrum(ax[3], 'A6DNAA16lb_5.4_150mM_25C_H2O_C8H8_HSQC_600/', 1.*math.pow(10, 6), 20, 1.4, "H8 (ppm)", "C8 (ppm)", [8.4, 8.0], [8.4, 8.1, 0.2], [142., 141.], [142., 141., 1.0], 'A6DNAA16lb_high_5.4_HSQC_25C_Aro.list', "C8", '%2.1f', '%d', "A" + "$_{6}$" + "-DNA(A16lb)\npH 5.4HS 25 " + "$^{\circ}$" + "C")
plot_spectrum(ax[4], 'A6DNAm1A16s2lb_5.4_25mM_25C_D2O_C1H1_HSQC_700/', 8.*math.pow(10, 6), 20, 1.4, "H1' (ppm)", "C1' (ppm)", [6.5, 5.3], [6.5, 5.4, 0.5], [88.5, 83.5], [88.0, 84.0, 2.0], 'A6DNAm1A16_T6lb_HSQC_C1p.list', "C1'", '%2.1f', '%d', "A" + "$_{6}$" + "-DNA" + "$^{m1A16}$" + "(s2lb)\npH 5.4 (D" + "$_{2}$" + "O) 25 " + "$^{\circ}$" + "C")
plot_spectrum(ax[5], 'A6DNAm1A16s2lb_5.4_25mM_25C_D2O_C8H8_HSQC_700/', 6.*math.pow(10, 5), 20, 1.4, "H6/8 (ppm)", "C6/8 (ppm)", [8.38, 7], [8.2, 7.4, 0.4], [144, 136.6], [144., 137., 3.], 'A6DNAm1A16_T6lb_HSQC_Aro.list', "C6", '%2.1f', '%d', "A" + "$_{6}$" + "-DNA" + "$^{m1A16}$" + "(s2lb)\npH 5.4 (D" + "$_{2}$" + "O) 25 " + "$^{\circ}$" + "C")
