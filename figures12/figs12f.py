...
# Plotting
fig, ax = plt.subplots()
plot_subplot(ax, sequence_contexts, deldelG_deltamelt, '$\Delta G^{\circ}_{conf,25 ^{\circ} C}$' + ' (kcal/mol)', [0.0, 6.0, 1.0], '%d', 'Sequence Contexts')
