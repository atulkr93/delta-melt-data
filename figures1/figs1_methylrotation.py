...
fig, axarr = plt.subplots(2, 6, figsize=(44, 14.4))
fig.suptitle('pH 6.8', fontsize=fs)
plot_uv(axarr[0, :3], '../figure7/a6rna_m6a_ph6.8bb/', 'test.csv', 'A' + "$_{6}$" + "-RNA" + "$^{m6A16}$", [[0.46, 0.66], [0.46, 0.66], [0.46, 0.66]], 0.05, [[5, 90.0], [5., 90.], [5., 90.]], 20.0, 1, '2state', 'duplex')
plot_uv(axarr[0, 3:], '../figure7/a6rna_dm6a_ph6.8bb/', 'test.csv', 'A' + "$_{6}$" + "-RNA" + "$^{m62A16}$", [[0.63, 0.77], [0.63, 0.78], [0.63, 0.78]], 0.05, [[5, 90.0], [5., 90.], [5., 90.]], 20.0, 1, '2state', 'duplex')
plot_uv(axarr[1, :3], '../figure7/dsgbc_m6a_ph6.8bb/', 'test.csv', 'dsGGACU' + "$^{m6A6}$", [[0.37, 0.47], [0.37, 0.47], [0.37, 0.47]], 0.04, [[5, 90.0], [5., 90.], [5., 90.]], 20.0, 1, '2state', 'duplex')
plot_uv(axarr[1, 3:], '../figure7/dsgbc_dm6a_ph6.8bb/', 'test.csv', 'dsGGACU' + "$^{m62A6}$", [[0.58, 0.72], [0.63, 0.74], [0.60, 0.73]], 0.05, [[5, 90.0], [5., 90.], [5., 90.]], 20.0, 1, '2state', 'duplex')
...
#plt.show()
plt.tight_layout()
plt.savefig('figs1_methylrotation.pdf')
