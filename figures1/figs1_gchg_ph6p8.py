...
plot_uv(axarr[0, :3], '../figure5_figure10/a6dna_ph6.8/', 'test.csv', 'A' + "$_{6}$" + "-DNA", [[0.54, 0.72], [0.54, 0.72], [0.52, 0.70]], 0.05, [[10, 90.0], [10., 90.], [10., 90.]], 15.0, 1, '2state', 'duplex')
plot_uv(axarr[0, 3:], '../figure5_figure10/a6dna_m1g10_keck_ph6.8nb/', 'test.csv', 'A' + "$_{6}$" + "-DNA" + "$^{m1G10}$", [[0.53, 0.70], [0.54, 0.70], [0.54, 0.70]], 0.05, [[10, 90.0], [10., 90.], [10., 90.]], 15.0, 1, '2state', 'duplex')
...
#plt.show()
plt.tight_layout()
plt.savefig('figs1_gchg_6p8.pdf')
