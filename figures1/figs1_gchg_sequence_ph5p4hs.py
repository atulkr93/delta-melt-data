...
fig, axarr = plt.subplots(5, 6, figsize=(44.1, 34.85))
fig.suptitle('pH 5.4HS', fontsize=fs)
plot_uv(axarr[0, :3], '../figure9/perkinelmer_uv/scaf2_aga_gc_ph5.4hsnb/', 'test.csv', 'scaf2_AGA' + '$^{GC}$', [[0.61, 0.79], [0.62, 0.8], [0.59, 0.76]], 0.05, [[10, 105.0], [10., 105.], [10., 105.]], 20.0, 1, '2state', 'duplex')
plot_uv(axarr[0, 3:], '../figure9/perkinelmer_uv/scaf2_aga_m1gc_ph5.4hsnb/', 'test.csv', 'scaf2_AGA' + '$^{m1GC}$', [[0.59, 0.77], [0.59, 0.77], [0.59, 0.77]], 0.05, [[10, 105.0], [10., 105.], [10., 105.]], 20.0, 1, '2state', 'duplex')
plot_uv(axarr[1, :3], '../figure9/perkinelmer_uv/scaf2_agc_gc_ph5.4hsnb/', 'test.csv', 'scaf2_AGC' + '$^{GC}$', [[0.58, 0.74], [0.64, 0.79], [0.63, 0.78]], 0.05, [[10, 105.0], [10., 105.], [10., 105.]], 20.0, 1, '2state', 'duplex')
plot_uv(axarr[1, 3:], '../figure9/perkinelmer_uv/scaf2_agc_m1gc_ph5.4hsnb/', 'test.csv', 'scaf2_AGC' + '$^{m1GC}$', [[0.61, 0.77], [0.60, 0.73], [0.60, 0.73]], 0.05, [[10, 105.0], [10., 105.], [10., 105.]], 20.0, 1, '2state', 'duplex')
plot_uv(axarr[2, :3], '../figure9/perkinelmer_uv/scaf2_agg_gc_ph5.4hsnb/', 'test.csv', 'scaf2_AGG' + '$^{GC}$', [[0.59, 0.74], [0.65, 0.80], [0.53, 0.69]], 0.05, [[10, 105.0], [10., 105.], [10., 105.]], 20.0, 1, '2state', 'duplex')
plot_uv(axarr[2, 3:], '../figure9/perkinelmer_uv/scaf2_agt_gc_ph5.4hsnb/', 'test.csv', 'scaf2_AGT' + '$^{GC}$', [[0.62, 0.78], [0.57, 0.74], [0.59, 0.76]], 0.05, [[10, 105.0], [10., 105.], [10., 105.]], 20.0, 1, '2state', 'duplex')
plot_uv(axarr[3, :3], '../figure9/perkinelmer_uv/scaf2_agt_m1gc_ph5.4hsnb/', 'test.csv', 'scaf2_AGT' + '$^{m1GC}$', [[0.61, 0.75], [0.67, 0.83], [0.58, 0.75]], 0.05, [[10, 105.0], [10., 105.], [10., 105.]], 20.0, 1, '2state', 'duplex')
plot_uv(axarr[3, 3:], '../figure9/perkinelmer_uv/scaf2_cga_gc_ph5.4hsnb/', 'test.csv', 'scaf2_CGA' + "$^{GC}$", [[0.59, 0.75], [0.64, 0.79], [0.64, 0.79]], 0.05, [[10, 105.0], [10., 105.], [10., 105.]], 20.0, 1, '2state', 'duplex')
...
plt.tight_layout()
plt.savefig('figs1_gchg_sequence_ph5p4hs.pdf')
