...
plot_uv(axarr[0, :3], '../figure5_figure10/a6dna_ph5.4nbhs/', 'test.csv', 'A' + '$_{6}$' + '-DNA', [[0.56, 0.78], [0.48, 0.68], [0.48, 0.68]], 0.05, [[10, 90.0], [10., 90.], [10., 90.]], 15.0, 1, '2state', 'duplex')
plot_uv(axarr[0, 3:], '../figure5_figure10/a6dna_m1g10_keck_ph5.4nbhs/', 'test.csv', 'A' + '$_{6}$' + '-DNA' + '$^{m1G10}$', [[0.55, 0.75], [0.56, 0.76], [0.55, 0.75]], 0.05, [[10, 90.0], [10., 90.], [10., 90.]], 15.0, 1, '2state', 'duplex')
...
#plt.show()
plt.tight_layout()
plt.savefig('figs1_gchg_5p4hs.pdf')
