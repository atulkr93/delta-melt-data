...
fig, axarr = plt.subplots(2, 6, figsize=(44, 14.5))
fig.suptitle('pH 5.4HS', fontsize=fs)
plot_uv(axarr[0, :3], '../figure3/a6dna_ph5.4nbhs/', 'test.csv', 'A' + '$_{6}$' + '-DNA', [[0.56, 0.78], [0.48, 0.68], [0.48, 0.68]], 0.05, [[10, 90.0], [10., 90.], [10., 90.]], 15.0, 1, '2state', 'duplex')
plot_uv(axarr[0, 3:], '../figure3/a6dna_m1a16_ph5.4hsnb/', 'test.csv', 'A' + '$_{6}$' + '-DNA' + '$^{m1A16}$', [[0.57, 0.78], [0.57, 0.78], [0.55, 0.76]], 0.05, [[10, 90.0], [10., 90.], [10., 90.]], 15.0, 1, '2state', 'duplex')
plot_uv(axarr[1, :3], '../figure3/a6dna_m1g10_keck_ph5.4nbhs/', 'test.csv', 'A' + '$_{6}$' + '-DNA' + '$^{m1G10}$', [[0.55, 0.75], [0.56, 0.76], [0.55, 0.75]], 0.05, [[10, 90.0], [10., 90.], [10., 90.]], 15.0, 1, '2state', 'duplex')
plot_uv(axarr[1, 3:], '../figure3/a6dna_m1a16m1g10_ph5.4hsnb/', 'test.csv', 'A' + '$_{6}$' + '-DNA' + '$^{m1G10,m1A16}$', [[0.55, 0.76], [0.52, 0.72], [0.52, 0.75]], 0.05, [[10, 90.0], [10., 90.], [10., 90.], [10., 90.]], 15.0, 1, '2state', 'duplex')
...
#plt.show()
plt.tight_layout()
plt.savefig('figs1_athg_5p4hs.pdf')
