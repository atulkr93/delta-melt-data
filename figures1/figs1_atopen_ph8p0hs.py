...
fig, axarr = plt.subplots(5, 6, figsize=(44, 35))
fig.suptitle('pH 8.0HS', fontsize=fs)
plot_uv(axarr[0, :3], '../figure6/opening/CDNA/wt/', 'test.csv', "TBP-DNA", [[0.62, 0.95], [0.62, 0.95], [0.62, 0.95]], 0.1, [[10, 100.0], [10., 100.], [10., 100.]], 20.0, 1, '2state', 'duplex')
plot_uv(list(axarr[0, 3:]) + [axarr[1, 0]], '../figure6/opening/CDNA/m3T3/', 'test.csv', "TBP-DNA" + "$^{m3T3}$", [[0.56, 0.79], [0.66, 0.89], [0.65, 0.86], [0.62, 0.86]], 0.05, [[10, 100.0], [10., 100.], [10., 100.], [10., 100.]], 20.0, 1, '2state', 'duplex')
plot_uv(list(axarr[1, 1:5]), '../figure6/opening/CDNA/m3T5/', 'test.csv', "TBP-DNA" + "$^{m3T5}$", [[0.60, 0.85], [0.63, 0.88], [0.64, 0.89], [0.65, 0.9]], 0.05, [[10, 100.0], [10., 100.], [10., 100.], [10., 100.]], 20.0, 1, '2state', 'duplex')
plot_uv([axarr[1, 5]] + list(axarr[2, :2]), '../figure6/opening/CDNA/m3T16/', 'test.csv', "TBP-DNA" + "$^{m3T16}$", [[0.61, 0.84], [0.59, 0.82], [0.59, 0.83], [0.6, 0.83]], 0.05, [[10, 100.0], [10., 100.], [10., 100.], [10., 100.]], 20.0, 1, '2state', 'duplex')
#plot_uv(list(axarr[2, 2:5]), '../figure6/opening/CDNA/m3T17/', 'test.csv', "TBP-DNA" + "$^{m3T17}$", [[0.56, 0.81], [0.61, 0.81], [0.58, 0.8], [0.59, 0.84]], 0.05, [[10, 100.0], [10., 100.], [10., 100.], [10., 100.]], 20.0, 1, '2state', 'duplex')
plot_uv(list(axarr[2, 2:5]), '../figure6/opening/CDNA/m3T17/', 'test.csv', "TBP-DNA" + "$^{m3T17}$", [[0.61, 0.81], [0.58, 0.8], [0.59, 0.84]], 0.05, [[10, 100.0], [10., 100.], [10., 100.], [10., 100.]], 20.0, 1, '2state', 'duplex')
plot_uv([axarr[2, 5]] + list(axarr[3, :2]), '../figure6/opening/CDNA/m3T18/', 'test.csv', "TBP-DNA" + "$^{m3T18}$", [[0.59, 0.82], [0.60, 0.83], [0.63, 0.86]], 0.05, [[10, 100.0], [10., 100.], [10., 100.], [10., 100.]], 20.0, 1, '2state', 'duplex')
plot_uv(list(axarr[3, 2:5]), '../figure6/opening/CDNA/m3T19/', 'test.csv', "TBP-DNA" + "$^{m3T19}$", [[0.6, 0.83], [0.6, 0.84], [0.59, 0.82]], 0.05, [[10, 100.0], [10., 100.], [10., 100.], [10., 100.]], 20.0, 1, '2state', 'duplex')
plot_uv([axarr[3,5]] + list(axarr[4, :2]), '../figure6/opening/CDNA/m3T21/', 'test.csv', "TBP-DNA" + "$^{m3T21}$", [[0.6, 0.84], [0.62, 0.85], [0.61, 0.85]], 0.05, [[10, 100.0], [10., 100.], [10., 100.], [10., 100.]], 20.0, 1, '2state', 'duplex')
...
#plt.show()
plt.tight_layout()
plt.savefig('figs1_atopen_ph8p0hs.pdf')
