...
plot_uv(axarr[0, :3], '../figure5_figure10/a2dna_ph4.4hs/', 'test.csv', 'A' + '$_{2}$' + '-DNA', [[0.62, 0.80], [0.62, 0.78], [0.62, 0.8]], 0.05, [[10, 80.0], [10., 80.], [10., 80.]], 20.0, 1, '2state', 'duplex')
plot_uv(axarr[0, 3:], '../figure5_figure10/a2dna_m1g10_ph4.4hsnb/', 'test.csv', 'A' + '$_{2}$' + '-DNA' + '$^{m1G10}$', [[0.55, 0.72], [0.55, 0.72], [0.55, 0.72]], 0.05, [[10, 80.0], [10., 80.], [10., 80.]], 20.0, 1, '2state', 'duplex')
...
#plt.show()
plt.tight_layout()
plt.savefig('figs1_gchg_4p4hs.pdf')
