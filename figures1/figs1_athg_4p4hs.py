...
fig, axarr = plt.subplots(2, 6, figsize=(46, 13.3))
fig.suptitle('pH 4.4HS', fontsize=fs)
plot_uv(axarr[0, :3], '../figure3/a6dna_ph4.4hsnb/', 'test.csv', 'A' + '$_{6}$' + '-DNA', [[0.57, 0.79], [0.57, 0.79], [0.57, 0.79]], 0.05, [[10, 90.0], [10., 90.], [10., 90.]], 20.0, 1, '2state', 'duplex')
plot_uv(axarr[0, 3:], '../figure3/a6dna_m1a16_4.4hsnb/', 'test.csv', 'A' + '$_{6}$' + '-DNA' + '$^{m1A16}$', [[0.48, 0.66], [0.57, 0.77], [0.57, 0.77]], 0.05, [[10, 90.0], [10., 90.], [10., 90.]], 20.0, 1, '2state', 'duplex')
...
#plt.show()
plt.tight_layout()
plt.savefig('figs1_athg_4p4hs.pdf')
