...
fig, axarr = plt.subplots(3, 6, figsize=(44, 21.3))
fig.suptitle('pH 5.4', fontsize=fs)

plot_uv(axarr[0, :4], '../figure3/a6dna_ph5.4/', 'test.csv', 'A' + '$_{6}$' + '-DNA', [[0.52, 0.71], [0.52, 0.72], [0.52, 0.72], [0.52, 0.71]], 0.05, [[0, 90.0], [0., 90.], [0., 90.], [0., 90.]], 20.0, 1, '2state', 'duplex')
plot_uv(list(axarr[0, 4:]) + [axarr[1, 0]], '../figure3/a6dna_m1a16_ph5.4/', 'test.csv', 'A' + '$_{6}$' + '-DNA' + '$^{m1A16}$', [[0.52, 0.71], [0.52, 0.71], [0.52, 0.70]], 0.05, [[0, 90.0], [0., 90.], [0., 90.]], 20.0, 1, '2state', 'duplex')
plot_uv(axarr[1, 1:4], '../figure3/a6dna_ra16_ph5.4nb/', 'test.csv', 'A' + '$_{6}$' + '-DNA' + '$^{rA16}$', [[0.52, 0.74], [0.52, 0.72], [0.52, 0.72]], 0.05, [[0, 90.0], [0., 90.], [0., 90.]], 20.0, 1, '2state', 'duplex')
plot_uv(list(axarr[1, 4:]) + [axarr[2, 0]], '../figure3/a6dna_m1ra16_ph5.4nb/', 'test.csv', 'A' + '$_{6}$' + '-DNA' + '$^{m1rA16}$', [[0.52, 0.7], [0.55, 0.76], [0.56, 0.76]], 0.05, [[0, 90.0], [0., 90.], [0., 90.]], 20.0, 1, '2state', 'duplex')
...
axarr[2, 0].set_xlabel('Temperature (' + '$^{\circ}$' + 'C)', fontsize=fs)
#plt.show()
plt.tight_layout()
plt.savefig('figs1_athg_5p4.pdf')
