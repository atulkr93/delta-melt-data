...
plot_uv(axarr[0, :3], '../figure6/opening/A6DNA/wt/', 'test.csv', 'A' + "$_{6}$" + "-DNA", [[0.64, 0.90], [0.64, 0.92], [0.61, 0.89]], 0.05, [[10, 100.0], [10., 100.], [10., 100.]], 20.0, 1, '2state', 'duplex')
plot_uv(axarr[0, 3:], '../figure6/opening/A6DNA/m3T5/', 'test.csv', 'A' + "$_{6}$" + "-DNA" + "$^{m3T5}$", [[0.63, 0.84], [0.63, 0.84], [0.60, 0.80]], 0.05, [[10, 100.0], [10., 100.], [10., 100.]], 20.0, 1, '2state', 'duplex')
plot_uv(axarr[1, :3], '../figure6/opening/A6DNA/m3T7/', 'test.csv', 'A' + "$_{6}$" + "-DNA" + "$^{m3T7}$", [[0.59, 0.81], [0.62, 0.84], [0.62, 0.85]], 0.05, [[10, 100.0], [10., 100.], [10., 100.]], 20.0, 1, '2state', 'duplex')
plot_uv(axarr[1, 3:], '../figure6/opening/A6DNA/m3T22/', 'test.csv', 'A' + "$_{6}$" + "-DNA" + "$^{m3T22}$", [[0.58, 0.80], [0.58, 0.81], [0.58, 0.81]], 0.05, [[10, 100.0], [10., 100.], [10., 100.]], 20.0, 1, '2state', 'duplex')
...
#plt.show()
plt.tight_layout()
plt.savefig('figs1_atopen_ph8p8hs.pdf')
