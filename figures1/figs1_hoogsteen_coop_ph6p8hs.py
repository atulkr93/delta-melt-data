...
fig, axarr = plt.subplots(3, 6, figsize=(44, 21))
fig.suptitle('pH 6.8HS', fontsize=fs)
plot_uv(axarr[0, :3], '../figure8/a2dna_ph6.8hsnb/', 'test.csv', 'A' + "$_{2}$" + "-DNA", [[0.61, 0.81], [0.62, 0.81], [0.62, 0.81]], 0.05, [[10, 100.0], [10., 100.], [10., 100.]], 20.0, 1, '2state', 'duplex')
plot_uv(axarr[0, 3:], '../figure8/a2dna_m1a7_ph6.8hsnb/', 'test.csv', 'A' + "$_{2}$" + "-DNA" + "$^{m1A7}$", [[0.62, 0.82], [0.64, 0.83], [0.64, 0.84]], 0.05, [[10, 100.0], [10., 100.], [10., 100.]], 20.0, 1, '2state', 'duplex')
plot_uv(axarr[1, :3], '../figure8/a2dna_m1a16_pH6.8hsnb/', 'test.csv', 'A' + "$_{2}$" + "-DNA" + "$^{m1A16}$", [[0.60, 0.80], [0.61, 0.79], [0.61, 0.80]], 0.05, [[10, 100.0], [10., 100.], [10., 100.]], 20.0, 1, '2state', 'duplex')
plot_uv(axarr[1, 3:], '../figure8/a2dna_m1a17_pH6.8hsnb/', 'test.csv', 'A' + "$_{2}$" + "-DNA" + "$^{m1A17}$", [[0.61, 0.82], [0.61, 0.82], [0.61, 0.82]], 0.05, [[10, 100.0], [10., 100.], [10., 100.]], 20.0, 1, '2state', 'duplex')
plot_uv(axarr[2, :3], '../figure8/a2dna_m1a7m1a17_pH6.8hsnb/', 'test.csv', 'A' + "$_{2}$" + "-DNA" + "$^{m1A7,17}$", [[0.62, 0.80], [0.62, 0.81], [0.64, 0.81]], 0.05, [[10, 100.0], [10., 100.], [10., 100.]], 20.0, 1, '2state', 'duplex')
plot_uv(axarr[2, 3:], '../figure8/a2dna_m1a16m1a17_pH6.8hsnb/', 'test.csv', 'A' + "$_{2}$" + "-DNA" + "$^{m1A16,17}$", [[0.58, 0.76], [0.58, 0.76], [0.58, 0.76]], 0.05, [[10, 100.0], [10., 100.], [10., 100.]], 20.0, 1, '2state', 'duplex')
...
#plt.show()
plt.tight_layout()
plt.savefig('figs1_hoogsteen_coop_ph6p8hsnb.pdf')
