...
def fit_data(filename, temperature, absorbance, mode, Ct):
    ...
    if mode == 'hairpin': 
        ...
        ax.set_yticklabels(['%.2f'%ele for ele in [0.55, 0.60, 0.65, 0.70]], fontsize=fl)
...
def caller():
    ...
    labels_net = []
    filenames_net = []
    for filename in ['../figure9/cary_uv/scaf2_tac_at_done/final_all/20210119_probe11_melting2_tac_at.txt']:
        if filename[-3:] == "txt":
